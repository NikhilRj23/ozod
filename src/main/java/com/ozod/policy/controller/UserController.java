...
import com.ozod.policy.dto.LoginDto;
...
public class UserController {
	...
	@PostMapping("/login")
	public ResponseEntity<UserDto> findUser(@RequestBody LoginDto dto) {
		UserDto user = service.findByEmailPassword(dto.getEmail(),dto.getPassword());
